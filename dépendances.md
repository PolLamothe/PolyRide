...
| **S1-DB-1** | Schéma SQL initial (Users/Events) | Kyllian | *Aucun* | S1-BE-2, S2-DB-1 |
...
| ID | Tâche | Responsable | Dépend de (Préréquis) | Bloque (Est requis pour) |
| :--- | :--- | :--- | :--- | :--- |
| **S2-DB-1** | Scripts migration SQL (Trajets/Réserv.) | Kyllian | S1-DB-1 | S2-BE-3 |
...
| ID | Tâche | Responsable | Dépend de (Préréquis) | Bloque (Est requis pour) |
| :--- | :--- | :--- | :--- | :--- |
| **S3-DB-1** | Migration SQL (Messagerie) | Kyllian | S1-DB-1 | S3-BE-1 |
...
graph TD
    ...
    subgraph Sprint 2 [S2 : Fonctionnel Core]
        S1-DB-1 --> S2-DB-1(Migration Trajets):::db
    ...
    subgraph Sprint 3 [S3 : Interaction]
        S3-DB-1(Migration Chat):::db --> S3-BE-1(Socket.io Back):::backend
        S1-BE-1 --> S3-BE-1
